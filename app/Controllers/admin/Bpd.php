...
class Bpd extends BaseController
{
    ...
    // ✅ DATA MEMBER (sama seperti di BPN)
    public function dataMember()
    {
        ...
        // ambil data kota dari tabel
        $kota = $this->kotaModel->find($idKota);

        // ✅ Ambil semua data member yang terkait kota BPD
        $members = $this->memberModel
            ...
            ->where('tb_members.status', 'Aktif')
            ->orderBy('tb_members.id', 'DESC')
            ->findAll();
    ...
    {
        return view('admin/bpd/artikel/buat', ['title' => 'Buat Artikel Baru']);
    }
