...
<div class="container-fluid mt-4">
    <h3 class="gold-text gold-shadow mb-3"><i class="bi bi-people-fill me-2"></i> Manajemen Admin BPW</h3>
    ...
    <a href="<?= base_url('admin/bpn/adminbpw/create') ?>" class="btn btn-gold mb-3">
        <i class="bi bi-plus-circle me-1"></i> Tambah BPW Admin
    </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <a href="<?= base_url('admin/bpn/adminbpw/delete/' . $bpw['id']) ?>" class="btn btn-danger btn-sm"
