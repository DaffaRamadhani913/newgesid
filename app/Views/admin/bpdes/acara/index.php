...
<div class="container-fluid">
    ...
    <a href="<?= base_url('/admin/bpdes/buat-acara') ?>" class="btn btn-gold mb-3">
                    ...
                    <tbody>
                        <?php foreach ($acaras as $i => $a): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('/admin/bpdes/edit-acara/' . $a['id']) ?>"
                                        class="btn btn-warning btn-sm">
                                        <i class="bi bi-pencil-square"></i> Edit
                                    </a>
                                    <form action="<?= base_url('/admin/bpdes/delete-acara/' . $a['id']) ?>" method="post"
