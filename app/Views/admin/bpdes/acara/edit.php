...
<div class="container-fluid">
    ...
    <form action="<?= base_url('/admin/bpdes/acara/update/'.$acara['id']) ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <a href="<?= base_url('/admin/bpdes/acara') ?>" class="btn btn-secondary">Kembali</a>
    </form>
</div>
