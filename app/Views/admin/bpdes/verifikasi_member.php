...
<div class="container-fluid py-4">
    <h4 class="mb-1 fw-bold">Verifikasi Member BPDes</h4>
    <p class="text-muted mb-4">Data pendaftaran member GESID yang berada di desa Anda. Anda hanya dapat melihat data.</p>
                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <?php if (empty($members)): ?>
                            <tr>
                                <td colspan="13" class="text-center text-muted">Tidak ada data member dari desa Anda.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
