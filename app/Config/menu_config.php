...
return [
  'bpn' => [
    ...
    'okk' => [
      ...
      ['url' => 'admin/bpn/adminbpd', 'icon' => 'mdi:account-tie-outline', 'label' => 'BPD'],
      ['url' => 'admin/bpn/adminbpdes', 'icon' => 'mdi:account-tie-outline', 'label' => 'BPDes'],
    ],
  ...
  'member' => [
    ...
    ['url' => 'member/profile', 'icon' => 'mdi:account-circle-outline', 'label' => 'Edit Profil'],
